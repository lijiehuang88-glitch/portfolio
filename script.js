...
const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${GEMINI_API_KEY}`;
    ...
    【規則】生氣加[angry]，無奈加[sad]，驚訝加[surprised]。嚴禁輸出(無標籤)。
    `;
...
window.setLang = function(lang, btnElement) {
    const translations = {
        'zh': {
            ...
            about_title: '關於我',
            about_intro: '你好！我是 <strong>黃立杰</strong>，目前就讀於<strong>龍華科技大學 多媒體與遊戲發展科學系</strong>。',
            about_desc: '自認為是一個充滿好奇心的「技術應用者」。我不將自己侷限在單一領域，而是喜歡探索新工具的可能性——特別是 <strong>AI 技術</strong>與 <strong>3D 互動</strong>的結合。雖然我不從零開始撰寫複雜的程式碼，但我擅長<strong>研究並重現</strong>技術，將現有的資源整合成有趣的互動體驗。',
            about_hobby: '我的創作養分來自於廣泛的閱讀。從<strong>文學與漫畫</strong>中學習敘事結構，從<strong>心理學</strong>中分析角色動機，甚至從<strong>數學</strong>中尋找邏輯的美感。這些跨領域的知識，讓我在規劃遊戲世界觀與系統架構時，能兼具感性與理性。',
        ...
        'en': {
            ...
            about_intro: 'Hi! I am <strong>Lijie Huang (LJ)</strong>, currently studying at <strong>Lunghwa University of Science and Technology</strong>.',
            about_desc: 'I consider myself a curious "Technology Applicator." I love exploring the possibilities of new tools, especially the combination of <strong>AI</strong> and <strong>3D Interaction</strong>. While I don\'t code complex systems from scratch, I excel at <strong>researching and reproducing</strong> technologies, integrating resources into engaging interactive experiences.',
            about_hobby: 'My inspiration comes from extensive reading—learning narrative structures from <strong>Literature & Manga</strong>, analyzing character motives through <strong>Psychology</strong>, and finding logical beauty in <strong>Math</strong>. This cross-disciplinary knowledge allows me to balance sensibility and rationality in game design.',
            ...
            my_name: 'Lijie Huang', my_address: 'Dongshan Township, Yilan County',
        ...
        'jp': {
            ...
            about_title: '私について',
            about_intro: 'こんにちは！<strong>黄 立杰（コウ・リツケツ）</strong>です。現在、<strong>龍華科技大学 多メディア・ゲーム開発科学科</strong>に在籍しています。',
            about_desc: '私は好奇心旺盛な「技術応用者」です。<strong>AI技術</strong>と<strong>3Dインタラクション</strong>の融合など、新しいツールの可能性を探ることが大好きです。複雑なコードをゼロから書くわけではありませんが、技術を<strong>研究・再現</strong>し、既存のリソースを統合して面白い体験を作り出すことを得意としています。',
            about_hobby: '私のインスピレーションは多読から来ています。<strong>文学や漫画</strong>から物語構造を学び、<strong>心理学</strong>でキャラクターの動機を分析し、<strong>数学</strong>から論理的な美しさを見出します。これらの知識により、ゲームの世界観やシステム構築において、感性と理性のバランスを保つことができます。',
